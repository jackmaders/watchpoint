...
describe("HistoryDetailPage component", () => {
	it("renders not found state when playthrough is null", () => {
		// Arrange & Act
		render(<HistoryDetailPage playthrough={null} />);
	...
	it("renders playthrough details, metrics, and scenario snapshots breakdown", () => {
		// Arrange & Act
		render(<HistoryDetailPage playthrough={mockDetailPlaythrough} />);
	...
	it("renders loading skeletons when isLoading is true", () => {
		// Arrange & Act
		render(<HistoryDetailPage isLoading={true} />);
	...
	it("renders in-progress playthrough details and handles timed out attempt and unanswered snapshot", () => {
		...
		// Act
		render(<HistoryDetailPage playthrough={inProgressItem} />);
	...
	it("renders error state without retry button when onRetry is omitted", () => {
		// Arrange & Act
		render(<HistoryDetailPage error="Fatal network failure" />);
	...
	it("renders header with fallback labels when vod metadata is undefined", () => {
		...
		// Act
		render(<HistoryDetailPage playthrough={itemWithoutVod} />);

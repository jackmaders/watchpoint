...
3. **Feature Decomposition**: When fog is cleared, run `/to-features` on the completed map to break down the initiative into sequenced, dependency-linked feature issues.

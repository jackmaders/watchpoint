...
* **Database Schema ([ADR-002](../adr/0002-hybrid-relational-schema-polymorphic-input.md))**: Utilizes a Cloudflare D1 (SQLite) database managed via Prisma ORM using a **Hybrid Relational Schema with Polymorphic JSON Payloads**.

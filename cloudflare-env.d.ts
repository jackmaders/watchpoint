/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --include-runtime=false --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: c94a2b112617458f7c1198b1e796fb84)
